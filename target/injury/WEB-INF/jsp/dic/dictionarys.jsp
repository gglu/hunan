...
<body>
	...
	<form action="users.do" method="post" id="frm">
		<div class="chaxunzd">
			<ul>
				<li class="li1">
					类别：<input id="account" name="account" type="text" class="inputtext" value="${accoutn}" />
					代码值：<input id="locked" name="locked" type="text" class="inputtext" value="${status}" />
				</li>
				<li >
					<div class="buttons">
						...
						<button class="positive" onclick="return clearForm();">修改</button>
					</div>
				</li>
			</ul>
		</div>
			...
			<td bgcolor="#bdc0ab">
				<table border="0" align="center" cellpadding="0" cellspacing="1" >
					<tr class="szjkzx2">
						...
						<td align="center" bgcolor="#FFFFFF">类别代码</td>
						<td align="center" bgcolor="#FFFFFF">名字</td>
						<td align="center" bgcolor="#FFFFFF">代码值</td>
