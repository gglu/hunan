     ...
     <div class="zlcd">
          ...
          <div class="cddz">
            <div id="my_menu" class="sdmenu">
                <div class="collapsed"  >
					<span><label>系统维护</label>
					</span>
					<a href="users.do" target="mainFrame2" >系统会员</a>
					<a href="res/all.do" target="mainFrame2" >系统资源</a>
					<a href="role/all.do" target="mainFrame2" >系统角色</a>
					<a href="org/all.do" target="mainFrame2" >系统机构</a>
					<a href="dic/all.do" target="mainFrame2" >系统字典</a>
                </div>
                <div class="collapsed"  >
